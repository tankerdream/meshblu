...
function socketLogic (socket, secure, skynet){
  ...
  socket.on('message', function(data) {
    ...
    s_authorizeRequest(data, function(error, fromDevice){
      ...
      skynet.sendMessage(fromDevice, message,null,function(error){
        ...
        return socket.emit('message',{devices:data.devices, subdevice: data.subdevice, payload: data.payload});
  ...
  socket.on('subscribe', function(data) {
    ...
    s_authorizeRequest(data, function(error, fromDevice){
      ...
      if(!data) {
        return s_emitError(socket,{error: "not enough information to subscribe"});
      }
