...
function s_getAuthUuidAndToken(req) {

  var  authUuid = req.header('uuid');
  var  authToken = req.header('token');
...
function s_getAuthDeviceFromRequest(req, callback) {
  //TODO body不是json时返回错误
  var result = s_getAuthUuidAndToken(req);
  if (!result.uuid && !result.token) {
    return callback(new hyGaError(400, 'Bad request'));
  }
  authDevice(result.uuid, result.token, callback);
}

function hyga_response(res, error, data){
  var message = {};
  if (error) {
...
function setupHttpRoutes(server, skynet){
  ...
  server.post('/register', function(req, res){
    ...
    s_register(req.body, function(error, device){

      return hyga_response(res, error, device);
  ...
  server.get('/whoAmI', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice) {

      hyga_response(res, error, fromDevice);
  ...
  server.put('/update', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice) {
      ...
      if (error) {
        return hyga_response(res, error, null);
      }
      updateFromClient(fromDevice, req.body, function(error, result){
        return hyga_response(res, error, result);
      });

    });
  });

  server.put('/update/:uuid', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice) {
  ...
  server.put('/updateList/:listName', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice) {
      ...
      req.body.api = 'push';
      req.body.listName = req.params.listName;

      s_updateList(fromDevice, req.body, function(error){
        return hyga_response(res, error);
      });

    });
  });

  server.put('/updateList/:listName/:uuid', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice) {
  ...
  server.delete('/updateList/:listName', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice) {
  ...
  server.delete('/updateList/:listName/:uuid', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice) {
  ...
  server.get('/device', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice){
      ...
      s_getOneDevice(fromDevice, req.query, function(error, data){
        return hyga_response(res, error, data);
      });

    });
  });

  server.delete('/device/:uuid', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice){
  ...
  server.post('/resetToken', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice){
      ...
      resetToken(fromDevice, req.body.uuid, function(error,token){
        return hyga_response(res, error, {token: token});
      });
  ...
  server.get('/devices', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice){
      ...
      s_getDevices(fromDevice, req.query, function(error, data){
        return hyga_response(res, error, data);
      });
  ...
  server.post('/sesToken/:uuid', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice){
  ...
  server.post('/message', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice){
      ...
      skynet.sendMessage(fromDevice, req.body, null, function(error, resp){
        return hyga_response(res, error, resp);
      });
  ...
  server.get('/subscribe', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice){
      ...
      subForwarder.subscribe(fromDevice, res);

    });

  });

  server.get('/subscribe/broadcast', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice){
      ...
      res.setHeader('Connection', 'keep-alive');
      subForwarder.subBroadcast(fromDevice, res);

    });
  });

  server.get('/subscribe/broadcast/:uuid', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice){
      ...
      res.setHeader('Connection', 'keep-alive');
      subForwarder.subBroadcast(fromDevice, res, req.params.uuid);
  ...
  server.post('/broadcast', function(req, res){
    s_getAuthDeviceFromRequest(req, function(error, fromDevice){
      ...
      skynet.broadcast(fromDevice, req.body, null, function(error, resp){
        return hyga_response(res, error, null);
      });
  ...
  server.get('/sdevices', function(req, res){
  ...
  server.post('/sdevices', function(req, res){
  ...
  server.put('/sdevices/:uuid', function(req, res){
    authorizeRequest(req, res, function(fromDevice){
      skynet.sendActivity(getActivity('devices',req, fromDevice));
  ...
  server.get('/ssubscribe/:uuid/broadcast', function(req, res){
    authorizeRequest(req, res, function(fromDevice){
      skynet.sendActivity(getActivity('subscribe',req, fromDevice));
  ...
  server.get('/ssubscribe/:uuid/received', function(req, res){
    authorizeRequest(req, res, function(fromDevice){
      skynet.sendActivity(getActivity('subscribe',req, fromDevice));
  ...
  server.get('/ssubscribe/:uuid/sent', function(req, res){
    authorizeRequest(req, res, function(fromDevice){
      skynet.sendActivity(getActivity('subscribe',req, fromDevice));
  ...
  server.get('/ssubscribe', function(req, res){
    authorizeRequest(req, res, function(fromDevice){
      skynet.sendActivity(getActivity('subscribe',req, fromDevice));
  ...
  server.post('/smessages', function(req, res, next){
    authorizeRequest(req, res, function(fromDevice){
  ...
  server.get('/sdata/:uuid', function(req, res){
    authorizeRequest(req, res, function(fromDevice){
      skynet.sendActivity(getActivity('data',req, fromDevice));
