...
var pullList = require('./s_updateList').pullList;
var pushList = require('./s_updateList').pushList;
...
var mqttServer = function(config, parentConnection){
  ...
  server.on('published', function(packet, client) {
    ...
    else if('pushList' === topic){
      pushList(client.skynetDevice, msg, function(error){
        hyga_emitClient(client.skynetDevice.uuid, 'ack', error, null, callbackId);
      });
    }else if('pullList' === topic){
      pullList(client.skynetDevice, msg, function(error){
        hyga_emitClient(client.skynetDevice.uuid, 'ack', error, null, callbackId);
      });
    }
