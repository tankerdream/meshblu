...
var fs = require('fs');
var debug = require('debug')('meshblu:httpServer');
var parentConnection = require('./getParentConnection');
var MessageIO = require('./MessageIO');

var httpParserError = require('./hyga-http-parser-error');
...
var httpServer = function(config, parentConnection) {
  ...
  io = new SocketIO(server, {path: '/socket.io'});
  ...
  app.set('query parser', function(body){
    return qs.parse(body, {arrayLimit: 0})
  });
